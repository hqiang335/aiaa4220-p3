...
2. **Docker Setup (Recommended)**
   ...
   # Login to DockerHub
   docker login
   docker pull zeyinggong/robosense_socialnav:v0.8
   
   # Alternative for network issues:
   # docker login quay.io -u <your-quay-username>
   # docker pull quay.io/zeyinggong/robosense_socialnav:v0.8
   ```
...
We recommend using Docker image v0.8 for local testing:
